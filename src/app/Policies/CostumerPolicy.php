...
class CostumerPolicy
{
    ...
    {
        return $user->can('view_any_costumer');
    }
    ...
    {
        return $user->can('create_costumer');
    }
    ...
    {
        return $user->can('update_costumer');
    }
    ...
    {
        return $user->can('delete_costumer');
    }
    ...
    {
        return $user->can('delete_any_costumer');
    }
     ...
     */
    public function replicate(User $user, Costumer $costumer): bool
    {
